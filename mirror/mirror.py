...
class clock_information(Frame):
    def __init__(self, parent, *arg, **kwargs):
        ...
        self.time1 = ''
        self.time_label = Label(self, font=(
            globalFonts, large_text_size), fg='white', bg='black')
        self.time_label.pack(side=TOP, anchor=E)

        self.day_of_week = ''
        self.day_of_week_label = Label(self, text=self.day_of_week, font=(
            globalFonts, small_text_size), fg='white', bg='black')
        self.day_of_week_label.pack(side=TOP, anchor=E)

        self.date = ''
        self.date_label = Label(self, text=self.date, font=(
            globalFonts, small_text_size), fg='white', bg='black')
...
class weather_data(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.forecast_label = Label(self, text=self.forecast, font=(
            globalFonts, medium_text_size), fg='white', bg='black')
        self.forecast_label.pack(side=TOP, anchor=W)

        self.temperature_label = Label(self, text=self.temperature, font=(
            globalFonts, small_text_size), fg='white', bg='black')
    ...
    def get_information_forecast(self):
        information_forecast = weather_data_info.weather_scrapping(
            weather_data_info.LINK)
...
class wikipedia_knowledge(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.title_label = Label(self, text=self.title, font=(
            globalFonts, medium_text_size), fg='white', bg='black')
        self.title_label.pack(side=TOP, anchor=W)

        self.content_data = wiki.wikipedia_info(
            random.choice(wiki.keyword_info))
        self.content_label = Label(self, text=self.content_data, font=(
            globalFonts, small_text_size), fg='white', bg='black', justify=LEFT, wraplength=1000)
        self.content_label.pack(side=TOP, anchor=W)

        self.wiki_data()

    def wiki_data(self):
        get_name_event = wiki.wikipedia_info(
            random.choice(wiki.keyword_info)).info_get_wiki()
...
class say_today_information(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.say_ai_label = Label(self, text=self.get_date_information, font=(
            globalFonts, small_text_size), fg='white', bg='black')
